# Generated by Django 4.1.3 on 2022-12-12 14:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='Описание', verbose_name='description')),
            ],
            options={
                'verbose_name': 'genre',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False, verbose_name='unique key')),
                ('role', models.TextField(choices=[('actor', 'actor'), ('director', 'director'), ('screenwriter', 'screenwriter')], default='actor', verbose_name='role')),
